...
public class Test {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new ClassReader(Test.class.getResourceAsStream("/test5/Hello.class")).accept(helloNode, 0);
        new ClassReader(Test.class.getResourceAsStream("/test5/World.class")).accept(worldNode, 0);
